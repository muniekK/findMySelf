...
$(document).ready(function() {
  ...
  $('#contact').click(loadFeedbackForm);
...
function submitFeedback() {
  ...
  if (isValid) {
    ...
    xhr.onreadystatechange = function() {
      if (xhr.status == 201) {
        document.getElementById('main-content').innerHTML = '<h7>Xin cảm ơn quý vị đã đóng góp ý kiến.</h7><br><h8>Thank you for your message. We appreciate you sharing your thoughts.</h8>';
      }
    };
